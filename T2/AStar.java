...
The development of A* and navigation was seperated for efficiency, the original task being aturn   list of nodes
generated by A*.

The algorithm moved from a generic implementation to practical when it was conjoined by Brandon to his
navigator functionality (using LejOS inbuilts) allowed the algorithm to be used practically. 
*/
